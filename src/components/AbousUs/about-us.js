import './about-us.css';
import img1 from './caricature-dimitri.svg';
import img2 from './caricature-mathilde.svg';
import img3 from './caricature-quentin_b.svg';
...
function AboutUs() {
  ...
  return (
    <div className="App" >
      ...
      <div id="middleColumn" className={visible?'fadeIn':'fadeOut'}>
        <div id="pageTitle1">
          <p>OUR TEAM</p>
        </div>
        <div id="pageData">
      ...
      <div id="rightColumn" className={visible?'fadeIn':'fadeOut'}>
        <div id="team">
